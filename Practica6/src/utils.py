...
def menu() -> None:  
    ...
    for i, problem in enumerate(problems):
        ...
        timedp = bcolors.WARNING + "Excessive" + \
            bcolors.ENDC if dp.Get_time() > 60 else dp.Get_time() * \
            1000  # Dynamic programming force time in ms
        row.append(timedp)
        ...
        timegreedy = bcolors.WARNING + "Excessive" + \
            bcolors.ENDC if greedy.Get_time() > 60 else greedy.Get_time() * \
            1000  # Greedy force time in ms
